                ...
                <div class="row match-height">
                    <div class="col-xl-8 col-12" id="ecommerceChartView">
                        <div class="card card-shadow">
                            <div class="py-20 card-header card-header-transparent">
                                ...
                                <ul class="float-right nav nav-pills nav-pills-rounded chart-action btn-group"
                                    role="group">
                            ...
                            <div class="p-20 bg-white widget-content tab-content">
                            ...
                            <div class="card-content">
                                <div id="new-orders" class="media-list position-relative">
                                    <div class="table-responsive">
                                        <table id="new-orders-table" class="table mb-0 table-hover table-xl">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="p-1 text-truncate">
                                                        <ul class="m-0 list-unstyled users-list">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-truncate"><i
                                                        class="mr-1 la la-dot-circle-o success font-medium-1"></i>
                                                    Paid</td>
                                            ...
                                            <tr>
                                                <td class="text-truncate"><i
                                                        class="mr-1 la la-dot-circle-o danger font-medium-1"></i>
                                                    Declined</td>
                                            ...
                                            <tr>
                                                <td class="text-truncate"><i
                                                        class="mr-1 la la-dot-circle-o warning font-medium-1"></i>
                                                    Pending</td>
                ...
                <div class="row match-height">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="mb-1 text-center chart-title">
                                    <h6>Total monthly Sales.</h6>
                                </div>
                                <div class="text-center chart-stats">
                                    <a href="#" class="mr-1 btn btn-sm btn-danger box-shadow-2">Statistics <i
                                            ...
                                            <div class="events-content">
                                                <ol>
                                                    <li class="selected" data-date="16/01/2015">
                                                        <blockquote class="border-0 blockquote">
                                                            <div class="media">
                                                                <div class="media-left">
                                                                    <img class="mr-1 media-object img-xl"
                                                                        src="../../../app-assets/images/portrait/small/avatar-s-5.png"
                                                            ...
                                                            <footer class="text-right blockquote-footer">Steve Jobs
